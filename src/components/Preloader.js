...
const Preloader = () => (
  <div className="App container">
    ...
    <p className="lead">
      ...
      standard deviation).{' '}
      <span>
        The best city for an H1B is <b>Kirkland, WA</b> with an
        average individual salary{' '}
        <b>$39,465 above local household median</b>. Median household
        salary is a good proxy for cost of living in an area.
      </span>
    </p>
    <img
      src={PreloaderImg}
